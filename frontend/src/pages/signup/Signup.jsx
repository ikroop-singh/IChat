			...
			<div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
				...
				<form onSubmit={handleSubmit}>
					<div>
						...
						<input value={input.fullName} onChange={(e)=>setInput({...input,fullName:e.target.value})}type='text' placeholder='Enter full name' className='w-full input input-bordered  h-10' />
					</div>
					...
					<GenderCheckbox handleGenderChange={handleGenderChange} selectedGender={input.gender}/>
